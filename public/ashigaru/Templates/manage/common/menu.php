<?php
$menus = [
  'top' => ['path'=>__BASE__.'/manage/', 'icon'=>'fas fa-layer-group', 'label'=>'トップ' ],
  'news' => ['path'=>__BASE__.'/manage/news/', 'icon'=>'fas fa-bullhorn', 'label'=>'お知らせ管理' ],
  // 'news' => ['path'=>__BASE__.'/manage/news/', 'icon'=>'fas fa-bullhorn',       'label'=>'お知らせ管理',
  //   'sub' => [
  //     'news-public'  => ['path'=>__BASE__.'/manage/news/public/',  'label'=>'一般のお知らせ' ],
  //     'news-member'  => ['path'=>__BASE__.'/manage/news/member/',  'label'=>'会員のお知らせ' ],
  //     'news-partner' => ['path'=>__BASE__.'/manage/news/partner/', 'label'=>'パートナーのお知らせ' ],
  //   ]
  // ],
  'site' => ['path'=>__BASE__.'/', 'icon'=>'fas fa-globe', 'label'=>'サイト', 'isBlank'=>true ],
  'logout' => ['path'=>__BASE__.'/manage/logout/', 'icon'=>'fas fa-power-off', 'label'=>'ログアウト' ],
];
?>
<ul>
