...
// ref: https://qiita.com/mpyw/items/8f8989f8575159ce95fc
...
class Csrf
{
    ...
    public static function check($input_name='csrf_token')
    {
        if(!self::validate(filter_input(INPUT_POST, $input_name))) {
