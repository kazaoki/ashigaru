...
INSERT INTO `ag-news` (published_at, category_id, title, type, url, is_blank) VALUES (CURRENT_TIMESTAMP, 3, 'リンクお知らせBBB（別窓）', 'url', 'https://yahoo.jp', TRUE);

-- サンプルお知らせ：PDFリンク
INSERT INTO `ag-news` (published_at, category_id, title, type, pdf_filename) VALUES (CURRENT_TIMESTAMP, 2, 'PDFお知らせ111', 'pdf', 'ほげほげ.pdf');
INSERT INTO `ag-news` (published_at, category_id, title, type, pdf_filename, is_blank) VALUES (CURRENT_TIMESTAMP, 1, 'PDFお知らせ222（別窓）', 'pdf', 'ふげふげ.pdf', TRUE);
