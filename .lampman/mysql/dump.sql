...
CREATE TABLE `ag-login_sessions` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='ログインセッション';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ag-login_sessions` VALUES (1,'2022-09-12 08:41:40','2022-09-12 17:41:40',1,'admin','172.23.0.1','73kg1au9otnm2c81odarl0pa7f'),(2,'2022-09-12 08:41:41','2022-09-12 17:41:41',1,'admin','172.23.0.1','73kg1au9otnm2c81odarl0pa7f');
...
-- Dump completed on 2022-09-12 17:59:08
